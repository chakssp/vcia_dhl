...
class KeyboardManager {
  ...
  setupDefaultShortcuts() {
    ...
    // Selection
    // Removido ctrl+a para evitar conflito com seleção de texto padrão do navegador
    this.register('alt+a', () => this.executeAction('select-all-visible'));
    ...
    // Search patterns
    this.register('alt+s', () => this.executeAction('manage-search-patterns'));
