    ...
    class IntelligenceEnrichmentPipeline {
        ...
        async initialize() {
            ...
            try {
                ...
                if (!KC.QdrantSchema) {
                    throw new Error('QdrantSchema não encontrado');
                }

                this.convergenceService = KC.ConvergenceAnalysisService;
                this.qdrantSchema = KC.QdrantSchema;
        ...
        _determineIntelligenceType(doc, breakthroughs) {
            ...
            if (doc.analysisType === 'Breakthrough Técnico') {
                return 'technical_innovation';
            }
            
            if (doc.analysisType === 'Momento Decisivo') {
