...
// AIDEV-NOTE: Sistema principal com validação completa de AIDEV comments
...
if (require.main === module) {
  (async () => {
    ...
    try {
      ...
      fs.writeFileSync(
        path.join(reportsDir, 'anchor-comments-report.txt'),
      ...
      if (report.summary.totalErrors === 0 && 
        ...
        console.log('\n❌ Correções necessárias - verifique os relatórios em mdesk/reports/');
        process.exit(1);
      }
