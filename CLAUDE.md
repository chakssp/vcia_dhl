...
**NÃO** modifique código que está funcionando sem seguir as diretrizes. Sempre preserve o código original em comentários e solicite aprovação antes de prosseguir com alterações significativas. Utilize os padrões
de segurança recomendados, como criptografia de chaves de API e implementação de cabeçalhos CSP para produção. Mantenha a transparência com o usuário sobre quaisquer exclusões ou filtragens de dados, garantindo que ele tenha controle total sobre essas ações. Utilize comentários âncora para facilitar a manutenção e a compreensão do código.
**NÃO** utilize dados STUB/MOCK, sempre siga as LEIS do projeto e utilize fontes reais de dados. Caso precise adicionar novas funcionalidades, peça orientação e siga as diretrizes de componentização máxima e preservação de funcionalidades já homologadas. Sempre documente suas mudanças e solicite
aprovação do usuário antes de prosseguir com qualquer alteração no código original. Utilize o padrão de sucesso fornecido para garantir a consistência e a qualidade do código. Mantenha a segurança em mente, implementando criptografia de chaves de API, limitação de taxa para chamadas de API e cabeçalhos CSP para produção. Sanitize o conteúdo exibido para evitar vulnerabilidades.
**NÃO** remova dados silenciosamente sem o conhecimento do usuário, sempre mantenha a transparência de dados e permita que o usuário veja e controle as exclusões. Utilize o padrão de sucesso fornecido para garantir a consistência e a qualidade do código. Mantenha a segurança em
mente, implementando criptografia de chaves de API, limitação de taxa para chamadas de API e cabeçalhos CSP para produção. Sanitize o conteúdo exibido para evitar vulnerabilidades. Utilize comentários âncora para facilitar a manutenção e a compreensão do código.
**NÃO** modifique código que está funcionando sem seguir as diretrizes. Sempre preserve o código original em comentários e solicite aprovação antes de prosseguir com alterações significativas. Utilize os padrões de segurança recomendados, como criptografia de chaves de API e implementação de cabeçalhos CSP para produção. Mantenha a transparência com o usuário sobre quaisquer exclusões ou filtragens de dados, garantindo que ele tenha controle total sobre essas ações. Utilize comentários âncora para facilitar a manutenção e a compreensão do código. Sempre siga as LEIS do projeto e o protocolo de início de sessão. Leia @CLAUDE.md e @RESUME-STATUS.md antes de fazer qualquer alteração. Utilize o padrão de sucesso fornecido para garantir a consistência e a qualidade do código.
